...
import "contracts/fndz/utils/FNDZControllerOwnerMixin.sol";
...
contract ChainlinkPriceFeed is IPrimitivePriceFeed, FNDZControllerOwnerMixin {
    ...
    ) public FNDZControllerOwnerMixin(_fndzController) {
    ...
    function setEthUsdAggregator(address _nextEthUsdAggregator) external onlyFNDZControllerOwner {
    ...
    ) external onlyFNDZControllerOwner {
    ...
    function removePrimitives(address[] calldata _primitives) external onlyFNDZControllerOwner {
